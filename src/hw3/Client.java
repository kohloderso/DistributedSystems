...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        ServiceLocator locator = new ServiceLocator(Protocol.ANNOUNCER_PORT, 5000);
        InetAddress address = locator.locate();
        client.request(new InetSocketAddress(address, Protocol.SERVER_PORT), "hurz", "+", 5, 5);
    }
